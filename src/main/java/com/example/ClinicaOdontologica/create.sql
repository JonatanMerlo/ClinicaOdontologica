...
create table IF NOT EXISTS pacientes(id int auto_increment primary key,nombre varchar(255),apellido varchar (255),dni varchar (255),email varchar(255),fecha_ingreso TIMESTAMP WITHOUT TIME ZONE,domicilio_id int);
